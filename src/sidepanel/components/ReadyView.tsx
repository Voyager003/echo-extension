...
export function ReadyView({ onStartLearning, onViewHistory }: ReadyViewProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-6 animate-fade-in">
      ...
      <button
        ...
        className="mt-3 px-6 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-medium transition-colors flex items-center gap-2"
      >
