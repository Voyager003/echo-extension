...
export function LoginPrompt({ onLogin, onOpenSettings }: LoginPromptProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-6 animate-fade-in">
      ...
      <button
        onClick={onLogin}
        className="px-6 py-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors flex items-center gap-3 shadow-sm"
      >
      ...
      <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg max-w-xs">
        <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
          <span className="font-medium">무료로 사용 가능</span>
          <br />
          Google Gemini AI의 무료 티어를 사용합니다.
        </p>
      </div>
    </div>
  );
